...
@SpringBootTest
@ActiveProfiles("test")
public class EmpresaServiceImplTest extends UtilsTests {
	...
	public void setUp() throws Exception {
		BDDMockito.given(this.empresaRepository.findByCnpj(Mockito.anyString())).willReturn(this.getEmpresa());
		BDDMockito.given(this.empresaRepository.save(Mockito.any(Empresa.class))).willReturn(this.getEmpresa());
	}
	...
	public void testPersistir() {
		Empresa empresa = this.empresaService.persistir(this.getEmpresa());;
