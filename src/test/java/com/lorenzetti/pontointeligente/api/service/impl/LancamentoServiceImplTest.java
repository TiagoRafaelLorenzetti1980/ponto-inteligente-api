...
@SpringBootTest
@ActiveProfiles("test")
public class LancamentoServiceImplTest extends UtilsTests {
	...
	public void setUp() throws Exception {
		...
		BDDMockito.given(this.lancamentoRepository.findById(Mockito.anyLong())).willReturn(this.getLancamentoInicioTrabalho(Boolean.TRUE));
